...
/** GitHub mark. Lucide deprecated its brand icons, so this is inlined. */
export function GitHubIcon({ className }: GitHubIconProps): ReactElement {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="currentColor"
